<script lang="ts">
    ...
    import { CheckCircle2, AlertCircle, XCircle, Loader2 } from '@lucide/svelte';
    ...
    const config = {
        ready: { variant: 'default' as const, icon: CheckCircle2, class: 'bg-green-500/10 text-green-600 border-green-500/20' },
        warning: { variant: 'secondary' as const, icon: AlertCircle, class: 'bg-amber-500/10 text-amber-600 border-amber-500/20' },
