...
<div class="relative font-mono border-25 w-[166mm] h-[130mm] border-yellow-500">
    <div class="flex w-full h-[13mm]">
        <div
            class="basis-[52mm] content-center border-r border-black text-center justify-center"
        >
    ...
    <div class="flex w-full h-[10mm] border-b border-black">
        <div
            class="basis-[26mm] content-center border-r border-black text-center justify-center"
        >
    ...
    <div
        class="w-full h-[8mm] border-b content-center justify-center text-center border-black"
    >
        <span class="font-bold tracking-wide text-xl">RACK NO.</span>
    </div>
    <div
        class="w-full h-[72mm] relative pt-[12mm] justify-center text-center border-black"
    >
